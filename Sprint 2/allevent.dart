...
class ProfilePage extends StatelessWidget {
  final List<Event> eventList = [
    Event('First Year Experience', '4 NOV 2023', '2pm - 9pm', 'BK 7', 'image/pic1.jpeg'),
    Event('Second Year Experience', '5 NOV 2023', '3pm - 10pm', 'BK 8', 'image/pic2.jpeg'),
    Event('Third Year Experience', '6 NOV 2023', '4pm - 11pm', 'BK 9', 'image/pic3.jpeg'),
    Event('Fourth Year Experience', '7 NOV 2023', '5pm - 12am', 'BK 10', 'image/pic4.jpeg'),
    Event('Fifth Year Experience', '8 NOV 2023', '6pm - 1am', 'BK 11', 'image/pic1.jpeg'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemCount: eventList.length * 2 - 1, // Adjust the item count to include dividers
  ...
  Widget buildEventWidget(String title, String date, String time, String location, String imagePath) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Row(
        children: [
